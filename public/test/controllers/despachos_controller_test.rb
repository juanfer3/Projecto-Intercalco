...
class DespachosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create despacho" do
    assert_difference('Despacho.count') do
      post despachos_url, params: { despacho: { celular: @despacho.celular, correo: @despacho.correo, direccion: @despacho.direccion, entregar_factura: @despacho.entregar_factura, estado: @despacho.estado, facturar: @despacho.facturar, lugar_de_despacho: @despacho.lugar_de_despacho, nit: @despacho.nit, nombre: @despacho.nombre, observacion: @despacho.observacion, pedido_id: @despacho.pedido_id, recibe: @despacho.recibe, telefono: @despacho.telefono } }
    end
