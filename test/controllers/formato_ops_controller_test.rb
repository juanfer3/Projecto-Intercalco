...
class FormatoOpsControllerTest < ActionDispatch::IntegrationTest
  setup do
    @formato_op = formato_ops(:one)
  end
  ...
  test "should destroy formato_op" do
    ...
    assert_redirected_to formato_ops_url
  end
end
