...
class LineaDeColoresControllerTest < ActionDispatch::IntegrationTest
  setup do
    @linea_de_color = linea_de_colores(:one)
  end

  test "should get index" do
    get linea_de_colores_url
  ...
  test "should create linea_de_color" do
    assert_difference('LineaDeColor.count') do
      post linea_de_colores_url, params: { linea_de_color: { descripcion: @linea_de_color.descripcion, estado: @linea_de_color.estado, nombre: @linea_de_color.nombre } }
    end
  ...
  test "should destroy linea_de_color" do
    ...
    assert_redirected_to linea_de_colores_url
  end
end
