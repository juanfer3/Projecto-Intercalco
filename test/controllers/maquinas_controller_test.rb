...
class MaquinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maquina" do
    assert_difference('Maquina.count') do
      post maquinas_url, params: { maquina: { descripcion: @maquina.descripcion, estado: @maquina.estado, nombre: @maquina.nombre } }
    end
  ...
  test "should update maquina" do
    patch maquina_url(@maquina), params: { maquina: { descripcion: @maquina.descripcion, estado: @maquina.estado, nombre: @maquina.nombre } }
