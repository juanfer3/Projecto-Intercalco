...
class OrdenesDeProduccionControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orden_de_produccion" do
    assert_difference('OrdenDeProduccion.count') do
      post ordenes_de_produccion_url, params: { orden_de_produccion: { cantidad: @orden_de_produccion.cantidad, codigo: @orden_de_produccion.codigo, descripcion: @orden_de_produccion.descripcion, estado: @orden_de_produccion.estado, fecha: @orden_de_produccion.fecha, fecha_final: @orden_de_produccion.fecha_final, inventario: @orden_de_produccion.inventario, numero_de_orden: @orden_de_produccion.numero_de_orden, pedido_id: @orden_de_produccion.pedido_id, total: @orden_de_produccion.total } }
    end
  ...
  test "should update orden_de_produccion" do
    patch orden_de_produccion_url(@orden_de_produccion), params: { orden_de_produccion: { cantidad: @orden_de_produccion.cantidad, codigo: @orden_de_produccion.codigo, descripcion: @orden_de_produccion.descripcion, estado: @orden_de_produccion.estado, fecha: @orden_de_produccion.fecha, fecha_final: @orden_de_produccion.fecha_final, inventario: @orden_de_produccion.inventario, numero_de_orden: @orden_de_produccion.numero_de_orden, pedido_id: @orden_de_produccion.pedido_id, total: @orden_de_produccion.total } }
