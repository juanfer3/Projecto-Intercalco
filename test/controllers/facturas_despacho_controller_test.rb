...
class FacturasDespachoControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factura_despacho" do
    assert_difference('FacturaDespacho.count') do
      post facturas_despacho_url, params: { factura_despacho: { cancelada: @factura_despacho.cancelada, estado: @factura_despacho.estado, numero_de_factura: @factura_despacho.numero_de_factura, pedido_id: @factura_despacho.pedido_id } }
    end
  ...
  test "should update factura_despacho" do
    patch factura_despacho_url(@factura_despacho), params: { factura_despacho: { cancelada: @factura_despacho.cancelada, estado: @factura_despacho.estado, numero_de_factura: @factura_despacho.numero_de_factura, pedido_id: @factura_despacho.pedido_id } }
