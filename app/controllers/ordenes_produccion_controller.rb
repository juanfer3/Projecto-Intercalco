class OrdenesProduccionController < ApplicationController
  ...
  def index
    @ordenes_produccion = OrdenProduccion.joins(:compromisos_de_entrega).paginate(page: params[:page], per_page: 20).order('compromisos_de_entrega.fecha_de_compromiso DESC').distinct
...
def import_ordenes_produccion_from_excel
  ...
  private
    ...
    def orden_produccion_params
      params.require(:orden_produccion).permit(:montaje_id,:contacto_id,:numero_de_orden,:contacto,:orden_de_compra,:orden_nueva,
